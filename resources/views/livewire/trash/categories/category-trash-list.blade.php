<div>
    @can('category-restore')
        <livewire:trash.categories.category-restore />
    @endcan

    @can('category-bulk-restore')
        <livewire:trash.categories.category-bulk-restore />
    @endcan

    @can('category-force-delete')
        <livewire:trash.categories.category-force-delete />
    @endcan

    @can('category-force-bulk-delete')
        <livewire:trash.categories.category-force-bulk-delete />
    @endcan
