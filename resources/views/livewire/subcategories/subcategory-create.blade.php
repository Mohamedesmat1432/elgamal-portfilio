<div>
    <x-modal name="create-subcategory-modal" :show="$errors->isNotEmpty()" focusable>
        <form wire:submit="create" class="p-6">
            ...
            <div class="mt-6">
                ...
                <x-text-input wire:model="form.name" id="createSubcategoryName" name="name" type="text"
            ...
            <div class="mt-6">
                ...
                <x-text-input wire:model="form.slug" id="createSubcategorySlug" name="slug" type="text"
            ...
            <div class="mt-6">
                ...
                <x-select wire:model="form.category_id" id="createSubcategoryCategoryId" name="category_id">
