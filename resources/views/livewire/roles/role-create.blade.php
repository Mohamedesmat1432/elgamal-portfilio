    ...
    <x-modal name="create-role-modal" :show="$errors->isNotEmpty()" focusable>
        <form wire:submit="create" class="p-6">
            ...
            <div class="mt-6">
                ...
                <x-text-input wire:model="form.name" id="createRoleName" name="name" type="text"
            ...
            <div class="mt-6">
                ...
                <x-select wire:model="form.permission" id="createRolePermission" name="permission" multiple>
